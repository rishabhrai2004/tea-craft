    ...
    <section className="gifting-section" id="gifting">
      <div className="gifting-container">
        <div className="gifting-content">
          ...
          <div className="gifting-price">${bundle.price.toFixed(2)}</div>
          <button className="btn-primary mt-4" onClick={() => addToCart(bundle)}>Gift The Collection</button>
        </div>
        <div className="gifting-visual">
          <img src="/macro_tea.png" alt="Gifting Box" className="gifting-img" />
